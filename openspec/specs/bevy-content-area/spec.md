...
Governs the layout and behavior of the content area when the Bevy UI backend is active. The content area is the main surface to the right of the sidebar rail that hosts the active view's content and a breadcrumb navigation bar.
