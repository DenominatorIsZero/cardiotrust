...
Governs the Bevy Volumetric view's workspace layout and interactive controls: prioritizing the 3-D viewport, exposing a collapsible right-edge control overlay, showing a resizable signal plot, supporting manual sample inspection, and adapting secondary panels for fullscreen and narrow-screen presentation.
