...
Governs the persistent sidebar rail rendered by the Bevy UI backend — its structure, expanded/collapsed display modes, auto-collapse behavior based on viewport width, per-item visual states, and logo area navigation.
