...
use super::{
    flat::offset_to_delay_index,
    shapes::{flat::ArrayDelaysFlat, normal::ArrayDelaysNormal},
};
...
pub fn calculate_delay_samples_array_normal(
    spatial_description: &SpatialDescription,
    propagation_velocities_m_per_s: &HashMap<VoxelType, f32>,
    sample_rate_hz: f32,
...
mod test {
    ...
    use super::{calculate_delay_s, calculate_delay_samples_array_normal};
    ...
    fn calculate_delay_samples_array_1() {
        ...
        let delay_samples = calculate_delay_samples_array_normal(
            spatial_description,
