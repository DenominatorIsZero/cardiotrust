...
use crate::core::{
    algorithm::estimation::{EstimationsFlat, EstimationsNormal},
...
mod tests {
    ...
    use crate::core::model::functional::allpass::shapes::{
        flat::ArrayIndicesGainsFlat, normal::ArrayIndicesGainsNormal,
    };

    use super::*;
    #[test]
    fn coef_normal_no_crash() {
    ...
    fn calculate_normal_no_crash() {
        ...
        let mut derivates = DerivativesNormal::new(number_of_states);
